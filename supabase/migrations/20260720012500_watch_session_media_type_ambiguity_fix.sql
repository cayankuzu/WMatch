...
BEGIN
  ...
  RETURNING
    public.currently_watching.movie_id::INTEGER,
    public.currently_watching.media_type::TEXT,
    public.currently_watching.state::TEXT,
    public.currently_watching.remaining_ms::INTEGER,
    public.currently_watching.expires_at,
    public.currently_watching.started_at,
    public.currently_watching.paused_at,
    public.currently_watching.version::INTEGER,
    public.currently_watching.updated_at;
