...
| 3 | [`brand-and-design-system.md`](brand-and-design-system.md) | Uygulamanın kendi token'larının dış yüzeylerdeki karşılığı: ölçülmüş kontrast tablosu, tipografi merdiveni, teslim öncesi kontrol listesi. |
| 4 | [`store-listing-tr.md`](store-listing-tr.md) | App Store ve Play için birebir kullanılacak metinler, karakter sayıları, gizlilik beyanı tabloları. |
| 5 | [`screenshot-storyboard.md`](screenshot-storyboard.md) | 6 store karesi, hangi ekran, hangi başlık, hangi durum, export adları. |
| 6 | [`ad-creative-briefs.md`](ad-creative-briefs.md) | 3 doğrulanabilir reklam angle'ı; 6 sn hook, 15 sn akış, static varyant, ölçülecek metrik. |
| 7 | [`go-to-market-plan.md`](go-to-market-plan.md) | Kanal önceliği, aşamalar, çıkış kriterleri, risk tablosu. |
| 8 | [`measurement-plan.md`](measurement-plan.md) | Funnel, olay tanımları, attribution, karar eşikleri. Yeni SDK eklenmiyor. |
| 9 | [`pitch-deck-outline-tr.md`](pitch-deck-outline-tr.md) | 10 slaytlık sunum iskeleti ve deck tasarım sistemi. |
| 10 | [`activation-and-first-value.md`](activation-and-first-value.md) | Mevcut akışın dönüşüm analizi: sürtünme noktaları, boş durum denetimi, bilinçli olarak kullanılmayan taktikler. |
...
| — | Ekran görüntülerinin `1.0.51` build'inden alınması | Store görselleri üretilemiyor — bkz. [`../MANUAL_STEPS.md`](../MANUAL_STEPS.md) §16 |
...
| [`../audit/ui-typography-hierarchy-audit.md`](../audit/ui-typography-hierarchy-audit.md) | Tipografi merdiveninin ölçümü ve onarımı |
| [`../audit/ui-screen-state-matrix.md`](../audit/ui-screen-state-matrix.md) | Materyalde gösterilebilecek ekran ve durumların tam listesi |
